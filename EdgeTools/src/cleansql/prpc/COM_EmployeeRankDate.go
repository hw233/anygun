...
type COM_EmployeeRankDate struct {
	instId_    uint32 //0
	rank_      int32  //1
	name_      string //2
	ownerName_ string //3
...
func (this *COM_EmployeeRankDate) Serialize(buffer *bytes.Buffer) error {
	//field mask
...
func (this *COM_EmployeeRankDate) Deserialize(buffer *bytes.Buffer) error {
	//field mask
