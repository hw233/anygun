...
type COM_EmployeeRankData struct {
	instId_    uint32 //0
	rank_      int32  //1
	name_      string //2
	ownerName_ string //3
...
func (this *COM_EmployeeRankData) Serialize(buffer *bytes.Buffer) error {
	//field mask
...
func (this *COM_EmployeeRankData) Deserialize(buffer *bytes.Buffer) error {
	//field mask
