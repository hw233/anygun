...
func (this *COM_BabyRankDate) Serialize(buffer *bytes.Buffer) error {
	//field mask
...
func (this *COM_BabyRankDate) Deserialize(buffer *bytes.Buffer) error {
	//field mask
