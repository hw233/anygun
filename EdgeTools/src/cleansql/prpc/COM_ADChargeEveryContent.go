...
type COM_ADChargeEveryContent struct {
...
func (this *COM_ADChargeEveryContent) Serialize(buffer *bytes.Buffer) error {
	//field mask
...
func (this *COM_ADChargeEveryContent) Deserialize(buffer *bytes.Buffer) error {
	//field mask
