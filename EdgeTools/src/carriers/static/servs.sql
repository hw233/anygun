...
CREATE TABLE `Servs` (
  ...
  `LogDBHost` varchar(60) COLLATE utf8_bin NOT NULL,
  `LogDBPort` int(32) NOT NULL,
  `LogDBUsr` varchar(60) COLLATE utf8_bin NOT NULL,
  `LogDBPwd` varchar(60) COLLATE utf8_bin NOT NULL,
  `LogDBName` varchar(60) COLLATE utf8_bin NOT NULL,
  `Channels` varchar(128) COLLATE utf8_bin NOT NULL,
  `IsNewServ` int(11) NOT NULL,
  `Notice` varchar(2048) COLLATE utf8_bin NOT NULL,
  `SystemNotice` varchar(2048) COLLATE utf8_bin NOT NULL,
