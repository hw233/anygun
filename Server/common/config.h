...
#ifdef WIN32
typedef std::map< std::string, Player*> NamePlayerMap;
typedef std::map< U32, Player*> IdPlayerMap;
typedef std::map<S32,Guild*> IdGuildMap;
typedef std::map<std::string,Guild*> NameGuildMap;
typedef std::map<S32,COM_GuildMember> IdGuildMemberMap;
typedef std::map<std::string,AnyOauth> AnyOauthMap;
typedef std::map<std::string, SGE_ContactInfoExt*> NameContentInfoMap;
typedef std::map<U32, SGE_ContactInfoExt*> IdContentInfoMap;
typedef std::map<int32, SGE_PlayerEmployeeQuest* > PlayerEmployeeQuestTable;
#else 
