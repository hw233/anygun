#ifndef __BINCompressConnection_h__
#define __BINCompressConnection_h__


#include "ProtocolMemReader.h"
#include "ProtocolWriter.h"

#include "CompressConnection.h"
...
class BINCompressConnection : 
	public ProtocolWriter,
	public CompressConnection,
	public BIN_STUB
{
public:
	typedef unsigned short	HdrType;

	BINCompressConnection(size_t rbSize = 0XFFFFFF, size_t sbSize = 0XFFFFFF):
	CompressConnection(rbSize, sbSize),
	proxy_(NULL),
	hdr_(NULL)
	{
	}
