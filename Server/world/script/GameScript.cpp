...
GAME_SCRIPT_API(Sys, reload_item_table){
	ItemTable::load(DESIGN_TABLE_ROOT"ItemData.csv");
	R_NONE;
}

GAME_SCRIPT_API(Sys, reload_drop_table){
	DropTable::load(DESIGN_TABLE_ROOT"Drop.csv");
	R_NONE;
}

GAME_SCRIPT_API(Sys, reload_ai_table){
	MonsterClass::load(DESIGN_TABLE_ROOT"AIclass.csv");
	R_NONE;
}

GAME_SCRIPT_API(Sys, reload_quest_table){
	Quest::load(DESIGN_TABLE_ROOT"Quest.csv");
	R_NONE;
}
